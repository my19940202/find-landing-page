export const FAQList = {
    FAQ_EN: [
        {
            question: "Why did you create this extension?",
            answer: "The default browser search is limited and often lacks good mobile support. With recent advancements in AI, search can be much more powerful, which is why we built this extension."
        },
        {
            question: "How much does it cost?",
            answer: "The basic version, which is as powerful as some paid alternatives, is free. Advanced features are available for a one-time fee."
        },
        {
            question: "How can I learn to use iFinder's features?",
            answer: "You can visit our tutorial page to learn how to use iFinder effectively."
        }
    ],

    FAQ_ZH: [
        {
            question: "为什么要创建这个扩展程序？",
            answer: "浏览器的默认搜索功能较为基础，并且在移动端的支持不够好。随着人工智能的快速发展，搜索功能可以变得更加强大，这也是我们开发这个扩展程序的原因。"
        },
        {
            question: "这个扩展程序的费用是多少？",
            answer: "基础功能完全免费，且和一些付费的替代品一样强大。高级功能则需要一次性付费。"
        },
        {
            question: "如何学习使用 iFinder 的功能？",
            answer: "您可以访问我们的教程页面，学习如何有效使用 iFinder。"
        }
    ],
